...
# Create backend/notification_service.py
...
# Save backend/notification_service.py
with open("elderly-voice-agent/backend/notification_service.py", "w") as f:
    f.write(notification_service_py)
    
print("Created backend/notification_service.py")
